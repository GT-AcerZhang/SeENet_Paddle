...
def resnet18(pretrained=False, root="~/work/data/backbone", **kwargs):
...
def resnet34(pretrained=False, root="~/work/data/backbone", **kwargs):
...
def resnet50(pretrained=False, root="~/work/data/backbone", **kwargs):
    ...
    return _resnet('resnet50', Bottleneck, [3, 4, 6, 3], pretrained, model_path,
                   **kwargs)


def resnet101(pretrained=False, root="~/work/data/backbone", **kwargs):
    ...
    return _resnet('resnet101', Bottleneck, [3, 4, 23, 3], pretrained, model_path,
                   **kwargs)


def resnet152(pretrained=False, root="~/work/data/backbone", **kwargs):
    ...
    return _resnet('resnet152', Bottleneck, [3, 8, 36, 3], pretrained, model_path,
                   **kwargs)


def resnext50_32x4d(pretrained=False, root="~/work/data/backbone", **kwargs):
...
def resnext101_32x8d(pretrained=False, root="~/work/data/backbone", **kwargs):
...
def wide_resnet50_2(pretrained=False, root="~/work/data/backbone", **kwargs):
...
def wide_resnet101_2(pretrained=False, root="~/work/data/backbone", **kwargs):
